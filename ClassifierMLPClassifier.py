...
PATH_SAVE_MODEL = "files/saved_model/MLPClassifier.sav"


class ClassifierMLPClassifier:
    ...
    def predict(self, pipe):
        ...
        msg = "Melhor categoria usando MLPClassifier: " + predictCategory[0] + " com {:.1%} de acerto. ".format(predictProbab[0][1])
