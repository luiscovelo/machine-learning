...
PATH_SAVE_MODEL = "files/saved_model/DecisionTreeClassifier.sav"


class ClassifierDecisionTreeClassifier:
    ...
    def predict(self, pipe):
        ...
        msg = "Melhor categoria usando DecisionTreeClassifier: " + predictCategory[0] + " com {:.1%} de acerto. ".format(predictProbab[0][1])
