...
PATH_SAVE_MODEL = "files/saved_model/MultinomialNB.sav"


class ClassifierMultinomialNB:
    ...
    def predict(self, pipe):
        ...
        msg = "Melhor categoria usando MultinomialNB: " + predictCategory[0] + " com {:.1%} de acerto. ".format(predictProbab[0][1])
