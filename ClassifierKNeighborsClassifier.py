...
PATH_SAVE_MODEL = "files/saved_model/KNeighborsClassifier.sav"


class ClassifierKNeighborsClassifier:
    ...
    def predict(self, pipe):
        ...
        msg = "Melhor categoria usando KNeighborsClassifier: " + predictCategory[0] + " com {:.1%} de acerto. ".format(predictProbab[0][1])
