...
PATH_SAVE_MODEL = "files/saved_model/DummyClassifier.sav"


class ClassifierDummyClassifier:
    ...
    def predict(self, pipe):
        ...
        msg = "Melhor categoria usando DummyClassifier: " + predictCategory[0] + " com {:.1%} de acerto. ".format(predictProbab[0][1])
