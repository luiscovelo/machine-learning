...
from Util import logging, print_result

PATH_SAVE_MODEL = "files/saved_model/LogisticRegression.sav"
...
class ClassifierLogisticRegression:
    ...
    def predict(self, pipe):
        ...
        msg = "Melhor categoria usando LogisticRegression: " + predictCategory[0] + " com {:.1%} de acerto. ".format(predictProbab[0][1])
